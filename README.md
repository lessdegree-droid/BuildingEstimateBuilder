...
<img src="screenshotsbanner.png" alt="Building Estimate Builder" width="100%"/>
...
|---|---|
| ![Main](screenshotsmain.png) | ![AI](screenshotsai.png) |

| PDF — Professional A (Gold) | PDF — Bid Format (Steel Blue) |
|---|---|
| ![ProA](screenshotspdf_proa.png) | ![Bid](screenshotspdf_bid.png) |

| Autocad — Revit (add-ins) | KSR Rate Book |
|---|---|
| ![Minimal](screenshotsrevit.png) | ![KSR](screenshotsksr.png) |
| ![KSR](screenshotsAutocad.png) |  | ![KSR](screenshotsproject.png) |
