...
[Overview](#-overview) · [Features](#-features) · [BIM Integration](#-bim-integration) · [Demo](#-demo-video) · [Screenshots](#-screenshots) · [Installation](#-installation) · [API Reference](#-api-reference) · [Technologies](#-technologies)
...
[![Building Estimate Builder Demo](screenshots/screenshotsbanner.png)](https://youtu.be/HVMHc1z_-Ik)

> 📺 Click to watch full demo — AI · Revit · AutoCAD · PDF Export
